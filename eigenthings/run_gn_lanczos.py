...
args.dir = args.dir + 'Lanczos/'+args.dataset+'/seed='+str(args.seed)+'_lr='+str(args.lr_init)+'_damping='+str(args.lanczos_beta)+'_wd='+str(args.wd)+'_batch_size='+str(args.batch_size)+'/'
