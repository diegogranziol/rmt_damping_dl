...
args.dir = args.dir +'/'+ args.dataset+'/'+args.model+ '/SWA'+'/seed='+str(args.seed)+'_lr='+str(args.lr_init)+'_wd='+str(args.wd)+'_swastart='+str(args.swag_start)+'_swalr='+str(args.swag_lr)+'/'
