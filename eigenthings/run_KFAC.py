...
args.dir = args.dir + 'KFAC/'+args.dataset+'/seed='+str(args.seed)+'_lr='+str(args.lr_init)+'_damping='+str(args.damping)+'_wd='+str(args.wd)+'_decoupled_wd='+str(args.decoupled_wd)+'/'
