...
from optimizers import SWATS

print('numpy imported')

parser = argparse.ArgumentParser(description='SWATS/SWATS-W Training')
...
parser.add_argument('--lr_init', type=float, default=0.001, metavar='LR', help='initial learning rate for Adam phase')
