...
args.dir = args.dir + 'Shrinkage_SGD/'+args.dataset+'/seed='+str(args.seed)+'_lr='+str(args.lr_init)+'_wd='+str(args.wd)+'_swagstart='+str(args.swag_start)+'/'
...
columns = ['ep', 'lr', 'tr_loss', 'tr_acc', 'te_loss', 'te_acc', 'te_top5_acc','alpha', 'alpha_ma', 'mu', 'wd', 'norm', 'time', 'mem_usage']
if args.swag:
...
for epoch in range(start_epoch, args.epochs):
    ...
    values = [epoch + 1, lr, train_res['loss'], train_res['accuracy'], test_res['loss'],
              test_res['accuracy'], test_res['top5_accuracy'], alpha, alpha_ma, mu, wd, norm,
