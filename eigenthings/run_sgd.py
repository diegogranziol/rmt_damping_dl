...
parser.add_argument('--dir', type=str, default="/home/xwan/PycharmProjects/kfac-curvature/out/VGG16BN/SGD/run1",
...
# parser.add_argument('--resume', type=str, default="/home/xwan/PycharmProjects/kfac-curvature/out/VGG16BN/SGD/run1/checkpoint-00153.pt", metavar='CKPT',
...
if args.swag:
    args.dir += "SWA"
args.dir += '/seed='+str(args.seed)+'_lr=' + str(args.lr_init) + '_wd=' + str(
    args.wd) + '/'
