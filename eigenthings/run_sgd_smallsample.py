...
parser.add_argument('--dir', type=str, default="/home/xwan/PycharmProjects/kfac-curvature/out/VGG16BN/SGD_noschedule/run1",
...
parser.add_argument('--sub_sample_size', type=int, default=1000, help='sub_sample_size')
parser.add_argument('--sub_sample_seed', type=int, default=1, help='sub_sample_seed')
...
if args.swag:
    args.dir += "SWA"
args.dir += '/ss'+ '/seed='+str(args.seed)+'_lr=' + str(args.lr_init) + '_wd=' + str(
    args.wd) + '_size=' +str(args.sub_sample_size)+'_seed='+str(args.sub_sample_seed)+'/'
...
loaders, num_classes = data.loaders(
    args.sub_sample_size,
    args.sub_sample_seed,
    args.dataset,
    args.data_path,
    args.batch_size,
    args.num_workers,
