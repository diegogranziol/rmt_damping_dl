...
python3 autodamping_KFAC.py --dir out/  --dataset CIFAR100 --data_path data/ --model VGG16BN --lr_init 0.1 --damping 0.3 --epochs 300 --save_freq=25 --eval_freq=1 --no_schedule --wd_start=0
...
python3 autodamping_KFAC.py --dir out/  --dataset CIFAR100 --data_path data/ --model VGG16BN --lr_init 0.1 --damping 0.3 --epochs 300 --save_freq=25 --eval_freq=1 --no_schedule --wd_start=-1
