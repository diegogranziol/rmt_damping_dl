...
parser.add_argument('--dir', type=str, default="/home/xwan/PycharmProjects/kfac-curvature/out/VGG16BN/Adam/run1", required=False, help='training directory (default: None)')
...
parser.add_argument('--stats_batch', type=int, default=1024, metavar='B', help='batch size used to compute the statistics (default: 1)')
...
args.dir = args.dir + 'Adam_wd/lr='+str(args.lr_init)+'_decoupled_wd='+str(args.decoupled_wd)+'/'
...
for epoch in range(start_epoch, args.epochs):
    ...
    if epoch % args.wd_freq == 0:
        ...
        loss_stats = utils.loss_stats(loaders['train'], model, criterion, cuda=True, bn_train_mode=False)
