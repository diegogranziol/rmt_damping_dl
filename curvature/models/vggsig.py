"""
    SIGVGG model definition
    ported from https://github.com/pytorch/vision/blob/master/torchvision/models/SIGVGG.py
"""
...
__all__ = ['SIGVGG6','SIGVGG16basic','SIGVGG11', 'SIGVGG11BN','SIGVGG16', 'SIGVGG16BN', 'SIGVGG19', 'SIGVGG19BN',]
...
def make_layers(cfg, batch_norm=True):
    ...
    for v in cfg:
        if v == 'M':
            ...
            if batch_norm:
                layers += [conv2d, nn.BatchNorm2d(v), nn.LogSigmoid()]
            else:
                layers += [conv2d, nn.LogSigmoid()]
            in_channels = v
...
class SIGVGG11BN(Base):
    kwargs = {'batch_norm': True}


# The SIGVGG-16 model for Backpack - added by 30 Nov 2019
...
def get_backpacked_SIGVGG(model: SIGVGG, depth=6, batch_norm=False, num_classes=10, cuda=True):
