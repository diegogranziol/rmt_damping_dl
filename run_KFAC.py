...
args.dir = args.dir + 'KFAC/'+args.dataset+'/seed='+str(args.seed)+'_batch_size='+str(args.batch_size)+'_lr='+str(args.lr_init)+'_damping='+str(args.damping)+'_wd='+str(args.wd)+'_decoupled_wd='+str(args.decoupled_wd)+'_epochs='+str(args.epochs)+'/'
...
for epoch in range(start_epoch, args.epochs):
    ...
    if args.adaptive and epoch<10:
        utils.adjust_kfac_damping(optimizer,0.01)
    ...
    elif args.adaptive and epoch>10:
